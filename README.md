...
- **Ablation harness** for systematic configuration sweeps (budgets, prompts, blinding) with automated comparison tables
...
6. Run ablation studies to test configuration variations: `python scripts/run_ablation.py --config configs/ablation_example.yaml --backend echo --comparison-md runs/ablation_results.md`
...
- **Ablation study guide** (systematic config sweeps, comparison tables): `docs/ABLATION_GUIDE.md`
...
- How do I test configuration changes systematically? Use the ablation harness (`scripts/run_ablation.py`) to sweep variations and generate comparison tables. See `docs/ABLATION_GUIDE.md`.
